...
perturbaciones mutuas entre estrellas alcanzan una desviación relativa media de
$\sim 1.6\times10^{-1}$ en 100 años, con casos extremos como S62 ($\Delta r/r
\sim 5$) y mínimos como S87 ($\Delta r/r \sim 10^{-5}$).  El análisis estadístico
...
\begin{enumerate}[label=\textbf{C\arabic*.}, itemsep=5pt]
  ...
  \item \textbf{Las perturbaciones mutuas son pequeñas pero no despreciables.}
    La desviación relativa media es $\sim 1.6 \times 10^{-1}$ en 100 años para el
    conjunto completo, con valores extremos de $5.38$ (S62) y $1.18 \times 10^{-5}$
    (S87).  La relación de masas
