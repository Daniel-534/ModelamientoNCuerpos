...
perturbaciones mutuas inducen una precesión secular cuya tasa angular característica se estima como:
\begin{equation}
...
$\sim 2\times10^{-3}\,\text{rad\,yr}^{-1}$), lo que confirma que las perturbaciones N-cuerpos
